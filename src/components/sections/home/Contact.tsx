...
const DEFAULT_CONTACT = {
  ...
  mainTitleHighlight: 'Business Finances?',
  mainDescription:
    'Join thousands of small business owners who trust Accounta for their accounting needs. Get personalized support and start your free trial today.',
  formTitle: 'Start Your Free Trial',
  formDescription:
    "Tell us about your business and we'll set up your account within 24 hours. No credit card required.",
  submitButton: 'Get Free Trial',
  contactSectionTitle: 'Talk to Our Experts',
  method1Title: 'Email Support',
  method1Description: 'Get help with setup and questions',
  method1Contact: 'support@accounta.com',
  method2Title: 'Sales Team',
  method2Description: 'Speak with our accounting experts',
  method2Contact: '+1 (555) 123-ACCT',
  method3Title: 'Live Chat',
  method3Description: 'Instant help during business hours',
  method3Contact: 'Available Mon-Fri',
  ...
  office2City: 'Austin',
  office2Address: 'Tech Quarter, 401 Congress Ave',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'San Francisco',
  office3Address: 'SOMA District, 350 Mission St',
  ...
  supportNote: 'Priority support included with all paid plans',
  nameLabel: 'Business Owner Name *',
  namePlaceholder: 'Sarah Johnson',
  emailLabel: 'Business Email *',
  emailPlaceholder: 'sarah@yourbusiness.com',
  companyLabel: 'Business Name *',
  companyPlaceholder: 'Your Business LLC',
  messageLabel: 'Tell us about your business *',
  messagePlaceholder:
    'What type of business do you run? How many transactions per month? Any specific accounting challenges?',
} as const;
