...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Bookkeeping',
  title: 'Simplify your business finances with',
  titleHighlight: "Accounta's smart accounting",
  description:
    'Automate bookkeeping, generate professional invoices, and track expenses effortlessly. Built specifically for small businesses and entrepreneurs who want to focus on growth, not paperwork.',
  features: [
  ...
  imageAlt: 'Accounta dashboard showing financial overview',
  statsLabel1: 'Time Saved',
  statsValue1: '15 hrs/month',
  statsLabel2: 'Accuracy',
  statsValue2: '99.9% precise',
} as const;
