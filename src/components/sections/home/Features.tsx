...
const DEFAULT_FEATURES = {
  ...
  mainTitleHighlight: 'All in One Platform',
  mainDescription:
    'Streamline your accounting, invoicing, and financial reporting with our comprehensive solution designed specifically for small businesses and entrepreneurs.',
  feature1Title: 'Smart Expense Tracking',
  feature1Description:
    'Automatically categorize expenses, scan receipts with AI, and track business spending in real-time with bank sync.',
  feature1Badge: 'Expenses',
  feature2Title: 'Bank-Level Security',
  feature2Description:
    '256-bit SSL encryption, SOC 2 compliance, and multi-factor authentication to keep your financial data secure.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Accounting App',
  feature3Description:
    'Manage invoices, track expenses, and view reports on-the-go with our native iOS and Android apps.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Currency Support',
  feature4Description:
    'Handle international clients with automatic currency conversion and multi-currency financial reporting.',
  feature4Badge: 'Global',
  feature5Title: 'Advanced Financial Reports',
  feature5Description:
    'Generate P&L statements, cash flow reports, and tax summaries with one click. Perfect for tax season.',
  feature5Badge: 'Reports',
  feature6Title: 'Automated Bookkeeping',
  feature6Description:
    'AI-powered transaction categorization and automated reconciliation saves hours of manual bookkeeping work.',
  feature6Badge: 'Automation',
  feature7Title: 'QuickBooks Integration',
  feature7Description:
    'Seamlessly import data from QuickBooks, Xero, and other accounting software via secure API connections.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert CPA Support',
  feature8Description:
    'Get help from certified accountants via chat, email, or phone. Tax preparation assistance included.',
  feature8Badge: 'Support',
  feature9Title: 'Data Backup & Privacy',
  feature9Description:
    'Daily automated backups, GDPR compliance, and your financial data is never shared with third parties.',
